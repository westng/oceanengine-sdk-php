...
namespace Api\JuLiangQianChuan\Tools\CommentMgmt;
...
class Module extends BaseModule
{
    public function __call(string $name, array $arguments)
    {
        ...
        foreach (scandir($currentDir) as $dir) {
            ...
            $subNamespaceClass = __NAMESPACE__ . '\\' . $dir . '\\' . ucfirst($name);
            if (class_exists($subNamespaceClass)) {
                return new $subNamespaceClass($this->client);
            }
        }
